...
В таблице quotes "TIME" integer NOT NULL можно было тоже перевести в формат даты и использовать тип поля даты. + поле "TIME"
не уникально, поэтому не может быть PRIMARY KEY.
