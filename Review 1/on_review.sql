...
3)создается внешний ключ; 4) выполняется запрос, указано количество, выведенноых значений.
...
Но в целом все описано, в том числе какие форматы и в какой строчке необходимо изменить.
